...
const GuideAddStorie = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      navigate("/dashboard/guide-manage-story"); // Redirect to another page
    } catch (error) {
  ...
  return (
    <div className="flex flex-col items-center p-6 b min-h-screen">
